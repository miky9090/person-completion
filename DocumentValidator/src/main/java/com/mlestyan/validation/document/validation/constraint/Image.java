...
import com.mlestyan.validation.document.validation.impl.ImageValidator;
...
public @interface Image {
	String message() default "format must be one of {supportedFormats} size must be {width}x{height}";
	Class<?>[] groups() default { };
	Class<? extends Payload>[] payload() default { };
	SupportedImageFormat[] supportedFormats();
	int width();
	int height();
